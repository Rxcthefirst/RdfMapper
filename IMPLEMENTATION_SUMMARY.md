...
### Core Infrastructure
- `src/rdfmap/generator/matchers/base.py` (enhanced)
- `src/rdfmap/generator/embedding_cache.py` (new)
- `src/rdfmap/generator/semantic_matcher.py` (enhanced)
- `src/rdfmap/generator/evidence_categorizer.py` (new)
- `src/rdfmap/models/alignment.py` (enhanced)
...
**Status:** Phase 1 infrastructure complete and tested. Ready for Phase 2 (React UI) and Phase 3 (matcher enhancements).
