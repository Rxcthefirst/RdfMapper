...
### Month 2: RML Output Support (Optional but Recommended)

**Why**: Full roundtrip RML → RDFMap → RML

**Benefit**: Users can:
1. Import RML
2. Enhance with AI in your UI
3. Export back to RML
4. Use with other RML tools

**Implementation**:
- RML generator (inverse of parser)
- Preserve original RML structure where possible
- Add x-alignment as RDF comments

**Deliverable**: Bidirectional RML support
